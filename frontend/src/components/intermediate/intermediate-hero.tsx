  ...
  return (
    <div
      ...
      >
        ...
        <div className="flex-col items-center justify-center px-30">
          <div className="flex flex-col items-center gap-10">
            <div className="flex flex-col gap-2.5">
              <div className="flex gap-5 items-center justify-center">
                ...
                <div>
                  <p className="text-[var(--color-neutral-50)] bg-[var(--color-primary-800)] text-[18px] font-bold px-4.5 py-3 rounded-[5px]">
                    Intermediate Level
                  </p>
                </div>
              </div>
