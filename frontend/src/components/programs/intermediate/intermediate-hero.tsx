...
const IntermediateHero = ({ hero }: HeroProps) => {
  ...
  return (
    <div className="relative w-full overflow-hidden pt-15">
      ...
      <div
        className="absolute w-3/4 h-3/4 -mt-[3%] top-1/3 left-1/4 -translate-x-1/2 bg-contain bg-no-repeat -z-10 brightness-40 drop-shadow-[0_0_30px_rgba(20,74,200,0.2)]"
