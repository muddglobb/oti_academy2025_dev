  ...
  return (
    <div className="w-62 bg-neutral-50 flex flex-col border-r h-screen items-center">
      ...
      <div className="mt-auto p-2 w-full">
        <button className="w-full flex items-center justify-center px-4 py-2 border border-neutral-300 text-gray-400 rounded hover:bg-gray-500 hover:text-neutral-300">
