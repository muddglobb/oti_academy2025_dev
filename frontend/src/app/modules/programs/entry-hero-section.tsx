  ...
  return (
    <>
      <div className="relative w-full overflow-hidden">
        ...
        <div className="absolute w-3/4 h-3/4 -mt-[3%] top-1/4 left-1/5 -translate-x-1/2 bg-[url('/images/planet/planet-kuning.png')] bg-contain bg-no-repeat -z-10 brightness-40 drop-shadow-[0_0_30px_rgba(20,74,200,0.2)]"></div>
