...
const Mentor = () => {
    return (
        <Container className="flex flex-col gap-5 lg:gap-10 bg-neutral-900/40">
            <Image
            ...
            <Image
                ...
                style={{ top: "49%" }}
            />
            <div className="z-100 bg-gradient-to-b from-neutral-900/40 to-neutral-900/70 flex flex-col items-center justify-center py-10">
